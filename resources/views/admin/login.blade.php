          ...
          <div class="col-md-8 col-lg-6 col-xxl-3">
            ...
            <div class="card mb-0">
              <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.login.operation') }}">
                  @csrf
                  <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Username</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="username" value="{{ old('username') }}" required>
                  </div>
                  <div class="mb-4">
